...
public class UpdateMaterialInwardValidator : AbstractValidator<UpdateMaterialInwardDto>
{
    public UpdateMaterialInwardValidator()
    {
        ...
        RuleForEach(x => x.Lines).SetValidator(new UpdateMaterialInwardLineValidator());
    }
}

public class UpdateMaterialInwardLineValidator : AbstractValidator<UpdateMaterialInwardLineDto>
{
    public UpdateMaterialInwardLineValidator()
    {
